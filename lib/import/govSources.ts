...
export const GOV_SOURCES: GovSource[] = [
  ...
  },
  {
    ...
    format: "csv",
    hasPhone: true,
    datasetUrl: "https://data.gov.tw/dataset/39284",
    defaultUrl: "https://info.nhi.gov.tw/api/iode0000s01/Dataset?rId=A21030000I-D21005-001",
    phase: 1,
    note: "健保特約藥局全清單，含電話/地址；賣草本/保健品的首要 B2B 通路。",
    fields: {
      name:    ["醫事機構名稱", "機構名稱", "名稱"],
      address: ["地址", "醫事機構地址", "院所地址"],
      phone:   ["電話", "聯絡電話", "電話號碼"],
  ...
  {
    id: "gov:kindergarten",
    label: "幼兒園 / 教保機構（各縣市名冊）",
    industry: "幼兒園",
    format: "csv",
    hasPhone: true,
    datasetUrl: "https://data.gov.tw/datasets/search?p=1&size=20&s=_score_desc&q=%E5%B9%BC%E5%85%92%E5%9C%92%E5%90%8D%E5%86%8A",
    phase: 1,
    note: "全國無單一檔，各縣市教育局各自公布。到 data.gov.tw 搜『幼兒園名冊』取你要的縣市 CSV，貼上或填下載網址匯入（欄位自動對應）。",
    fields: {
      name:    ["幼兒園名稱", "園名", "機構名稱", "名稱"],
      address: ["地址", "園址", "機構地址", "地址全址"],
      phone:   ["電話", "聯絡電話", "電話號碼"],
      owner:   ["負責人", "園長", "代表人"],
    },
  },
  {
    ...
    format: "csv",
    hasPhone: true,
    datasetUrl: "https://data.gov.tw/datasets/search?p=1&size=20&s=_score_desc&q=%E6%89%98%E5%AC%B0%E4%B8%AD%E5%BF%83",
    phase: 1,
    note: "各縣市社會局各自公布。到 data.gov.tw 搜『托嬰中心』取縣市 CSV，貼上或填下載網址匯入。",
    fields: {
      name:    ["機構名稱", "托嬰中心名稱", "名稱"],
      address: ["地址", "機構地址", "地址全址"],
      phone:   ["電話", "聯絡電話", "電話號碼"],
      owner:   ["負責人", "主管", "代表人"],
    },
  },
  {
    ...
    format: "csv",
    hasPhone: false,
    datasetUrl: "https://data.fda.gov.tw/",
    phase: 1,
    note: "食藥署開放資料平台(data.fda.gov.tw)有化粧品製造/輸入/販售業者登錄，多含統編/地址。取 CSV 貼上或填下載網址匯入。",
    fields: {
      name:    ["廠商名稱", "業者名稱", "公司名稱", "名稱"],
      tax_id:  ["統一編號", "統編", "營利事業統一編號"],
      address: ["地址", "營業地址", "工廠地址", "登記地址"],
      phone:   ["電話", "聯絡電話"],
    },
  },
  {
    ...
    datasetUrl: "https://data.fda.gov.tw/",
    phase: 1,
    note: "食藥署『食品業者登錄』(fadenbook)——健康食品店/食品行等 B2B 買家，含統編/地址。到 data.fda.gov.tw 取檔貼上或填下載網址匯入。",
    fields: {
      name:    ["業者名稱", "公司名稱", "廠商名稱", "名稱"],
      tax_id:  ["統一編號", "統編", "營利事業統一編號"],
      address: ["登錄地址", "地址", "營業地址"],
      phone:   ["電話", "聯絡電話"],
    },
  },
